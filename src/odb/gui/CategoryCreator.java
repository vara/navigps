 ...
 * @author praise
 */
public class CategoryCreator extends javax.swing.JDialog {

    /** Creates new form CategoryCreator */
    public CategoryCreator(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int n = JOptionPane.showOptionDialog(rootPane, "Create category " + jTextField1.getText() + "?",
                "Prompt",
        ...
        if (n == 0) {
            System.out.println("check and create category");
            CategoryCreator.this.dispose();
        } else {
            CategoryCreator.this.dispose();
        }
