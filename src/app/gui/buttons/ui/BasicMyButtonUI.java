...
public class BasicMyButtonUI extends MyButtonUI{
// Shared UI object
    private final static BasicMyButtonUI buttonUI = new BasicMyButtonUI();
    ...
    public int getBaseline(JComponent c, int width, int height) {
        ...
        return getBaseline((JComponent)b, textRect.y, fm.getAscent(),
                                     textRect.width, textRect.height);
    }
    public static int getBaseline(JComponent c, int y, int ascent,
                                  int w, int h) {
